...
- It monitor the processes and events that takes place on a device , Ex: Authentication and user management, agent will offload these logs to a designated collector for processing , agents need to be installed onto devices to log such events
- Operating System
